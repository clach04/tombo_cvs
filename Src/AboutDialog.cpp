...
//#define TOMBO_VERSION_INFO TEXT("Tombo version ") TOMBO_VERSION
#define TOMBO_VERSION_INFO TEXT("Tombo SNAPSHOT 20060210")
//#define TOMBO_VERSION_INFO TEXT("Tombo 2.0 alpha 2")
